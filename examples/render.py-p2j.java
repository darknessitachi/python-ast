...
{
    public void wrap( source, outfile)
    {
        return this._wrap_code(source);
    }
    public void _wrap_code( source)
    {
        lines = list(source);
...
public void render_headers(data)
{
    lexer = EmailLexer();
